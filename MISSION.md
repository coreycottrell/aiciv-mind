...
| v0.2 | Role-based tool filtering, scratchpad hierarchy, fitness scoring, team lead manifests | **SHIPPED** |
| v0.3 | Inter-mind coordination protocol, Coordination API, dream coordination review | **SHIPPED** |
| v0.4 | Cross-civ team lead collaboration, direct ZMQ transport, self-improving evolution | Next |
